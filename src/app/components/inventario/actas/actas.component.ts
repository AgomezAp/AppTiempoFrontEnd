...
import { ActaEntrega, DetalleActa } from '../../../interfaces/Inventario/inventario';
import { Subscription } from 'rxjs';
import { FirmaService } from '../../../services/Inventario/firma.service';
...
export class ActasComponent implements OnInit, OnDestroy {
  ...
  cancelarActa(acta: ActaEntrega): void {
    ...
    const esFirmada = ['activa', 'devuelta_parcial', 'vencida'].includes(
      acta.estado,
    );

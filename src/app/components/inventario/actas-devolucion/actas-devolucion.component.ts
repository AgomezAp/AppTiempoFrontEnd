...
import { DevolucionService } from '../../../services/Inventario/devolucion.service';
import { WebsocketService } from '../../../services/Inventario/websocket.service';
import { PdfService } from '../../../services/Inventario/pdf.service';
...
export class ActasDevolucionComponent implements OnInit, OnDestroy {
  ...
  private conectarWebSocket(): void {
    ...
    this.subscriptions.push(
      this.websocketService.onDevolucionCreated().subscribe((acta:any) => {
    ...
    this.subscriptions.push(
      this.websocketService.onDevolucionSigned().subscribe((data:any) => {

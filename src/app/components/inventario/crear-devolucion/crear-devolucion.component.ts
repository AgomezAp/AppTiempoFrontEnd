...
import { DevolucionService, DispositivoEntregado } from '../../../services/Inventario/devolucion.service';
...
export class CrearDevolucionComponent implements OnInit, AfterViewInit {
  ...
  filtrarDispositivos(): void {
    ...
    this.dispositivosEntregadosFiltrados = this.dispositivosEntregados.filter(
      (d: any) =>

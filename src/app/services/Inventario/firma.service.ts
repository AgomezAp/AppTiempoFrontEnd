...
export class FirmaService {
  ...
  enviarSolicitudFirma(actaId: number, correoNotificacion?: string): Observable<any> {
    return this.http.post(`${this.apiUrl}/api/inventario/firma-externa/enviar/${actaId}`, {
      correoNotificacion
    });
  }
  ...
  reenviarCorreoFirma(actaId: number): Observable<any> {
    return this.http.post(`${this.apiUrl}/api/inventario/firma-externa/reenviar/${actaId}`, {});
  }
  ...
  obtenerEstadoFirma(actaId: number): Observable<EstadoFirma> {
    return this.http.get<EstadoFirma>(`${this.apiUrl}/api/inventario/firma-externa/estado/${actaId}`);
  }
}

...
export class DevolucionService {
  ...
  obtenerDispositivosEntregados(actaId?: number): Observable<DispositivoEntregado[]> {
    ...
    return this.http.get<DispositivoEntregado[]>(`${this.apiUrl}/api/inventario/actas-devolucion/dispositivos-entregados`, { params });
  }
  ...
  obtenerActasDevolucion(filtros?: { estado?: string; busqueda?: string }): Observable<ActaDevolucion[]> {
    ...
    return this.http.get<ActaDevolucion[]>(`${this.apiUrl}/api/inventario/actas-devolucion`, { params });
  }
  ...
  obtenerActaDevolucionPorId(id: number): Observable<ActaDevolucion> {
    return this.http.get<ActaDevolucion>(`${this.apiUrl}/api/inventario/actas-devolucion/${id}`);
  }
  ...
  crearActaDevolucion(formData: FormData): Observable<{ msg: string; acta: ActaDevolucion }> {
    return this.http.post<{ msg: string; acta: ActaDevolucion }>(`${this.apiUrl}/api/inventario/actas-devolucion`, formData);
  }
  ...
  enviarSolicitudFirma(actaId: number): Observable<{ msg: string; correo: string }> {
    return this.http.post<{ msg: string; correo: string }>(`${this.apiUrl}/api/inventario/actas-devolucion/enviar-firma/${actaId}`, {});
  }
  ...
  reenviarCorreoDevolucion(actaId: number): Observable<{ msg: string; correo: string }> {
    return this.http.post<{ msg: string; correo: string }>(`${this.apiUrl}/api/inventario/actas-devolucion/reenviar-firma/${actaId}`, {});
  }
  ...
  eliminarActaDevolucion(id: number): Observable<{ msg: string }> {
    return this.http.delete<{ msg: string }>(`${this.apiUrl}/api/inventario/actas-devolucion/${id}`);
  }
  ...
  obtenerActaPublica(token: string): Observable<any> {
    return this.http.get(`${this.apiUrl}/api/inventario/actas-devolucion/publica/${token}`);
  }
  ...
  firmarActa(token: string, firma: string): Observable<any> {
    return this.http.post(`${this.apiUrl}/api/inventario/actas-devolucion/publica/${token}/firmar`, { firma });
  }
  ...
  rechazarActa(token: string, motivo?: string): Observable<any> {
    return this.http.post(`${this.apiUrl}/api/inventario/actas-devolucion/publica/${token}/rechazar`, { motivo });
  }
}

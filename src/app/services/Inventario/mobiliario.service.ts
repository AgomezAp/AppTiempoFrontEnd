...
export class MobiliarioService {
  ...
  obtenerTiposInventario(): Observable<TipoInventario[]> {
    return this.http.get<TipoInventario[]>(`${this.apiUrl}/api/inventario/tipos-inventario`);
  }
  ...
  obtenerTipoPorCodigo(codigo: string): Observable<TipoInventario> {
    return this.http.get<TipoInventario>(`${this.apiUrl}/api/inventario/tipos-inventario/codigo/${codigo}`);
  }
  ...
  obtenerMobiliario(filtros?: {
    ...
    return this.http.get<Mobiliario[]>(`${this.apiUrl}/api/inventario/mobiliario`, { params });
  }
  ...
  obtenerMobiliarioDisponible(): Observable<Mobiliario[]> {
    return this.http.get<Mobiliario[]>(`${this.apiUrl}/api/inventario/mobiliario/disponibles`);
  }
  ...
  obtenerMobiliarioPorId(id: number): Observable<Mobiliario> {
    return this.http.get<Mobiliario>(`${this.apiUrl}/api/inventario/mobiliario/${id}`);
  }
  ...
  registrarMobiliario(formData: FormData): Observable<{ msg: string; mobiliario: Mobiliario }> {
    return this.http.post<{ msg: string; mobiliario: Mobiliario }>(
      `${this.apiUrl}/api/inventario/mobiliario`,
      formData
    );
  }
  ...
  actualizarMobiliario(id: number, mobiliario: Partial<CrearMobiliarioRequest>): Observable<{ msg: string; mobiliario: Mobiliario }> {
    return this.http.put<{ msg: string; mobiliario: Mobiliario }>(
      `${this.apiUrl}/api/inventario/mobiliario/${id}`,
      mobiliario
    );
  }
  ...
  agregarStock(id: number, request: MovimientoStockRequest): Observable<{
    ...
    return this.http.post<{
      ...
      stockAnterior: number;
      stockNuevo: number;
    }>(`${this.apiUrl}/api/inventario/mobiliario/${id}/agregar-stock`, request);
  }
  ...
  retirarStock(id: number, request: MovimientoStockRequest): Observable<{
    ...
    return this.http.post<{
      ...
      stockAnterior: number;
      stockNuevo: number;
    }>(`${this.apiUrl}/api/inventario/mobiliario/${id}/retirar-stock`, request);
  }
  ...
  ajustarStock(id: number, request: AjustarStockRequest): Observable<{
    ...
    return this.http.post<{
      ...
      stockAnterior: number;
      stockNuevo: number;
    }>(`${this.apiUrl}/api/inventario/mobiliario/${id}/ajustar-stock`, request);
  }
  ...
  obtenerEstadisticas(): Observable<EstadisticasMobiliario> {
    return this.http.get<EstadisticasMobiliario>(`${this.apiUrl}/api/inventario/mobiliario/estadisticas`);
  }
  ...
  obtenerHistorial(id: number): Observable<MovimientoMobiliario[]> {
    return this.http.get<MovimientoMobiliario[]>(`${this.apiUrl}/api/inventario/mobiliario/${id}/historial`);
  }
}

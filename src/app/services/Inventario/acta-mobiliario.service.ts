...
export class ActaMobiliarioService {
  ...
  obtenerActas(
    estado?: string,
    busqueda?: string,
  ): Observable<ActaMobiliario[]> {
    let params = new HttpParams();
    if (estado) params = params.set('estado', estado);
    if (busqueda) params = params.set('busqueda', busqueda);
    return this.http.get<ActaMobiliario[]>(
      `${this.apiUrl}/api/inventario/actas-mobiliario`,
      { params },
    );
  }
  ...
  obtenerActaPorId(id: number): Observable<ActaMobiliario> {
    return this.http.get<ActaMobiliario>(
      `${this.apiUrl}/api/inventario/actas-mobiliario/${id}`,
    );
  }

  obtenerActasActivas(): Observable<ActaMobiliario[]> {
    return this.http.get<ActaMobiliario[]>(
      `${this.apiUrl}/api/inventario/actas-mobiliario/activas`,
    );
  }

  crearActa(
    formData: FormData,
  ): Observable<{ msg: string; acta: ActaMobiliario }> {
  ...
  registrarDevolucion(
    ...
    return this.http.post<{ msg: string; acta: ActaMobiliario }>(
      `${this.apiUrl}/api/inventario/actas-mobiliario/${id}/devolucion`,
      formData,
    );
  }
  ...
  eliminarActa(id: number): Observable<{ msg: string }> {
    return this.http.delete<{ msg: string }>(
      `${this.apiUrl}/api/inventario/actas-mobiliario/${id}/eliminar`,
    );
  }
  ...
  enviarSolicitudFirma(
    id: number,
  ): Observable<{ msg: string; correo: string }> {
    return this.http.post<{ msg: string; correo: string }>(
      `${this.apiUrl}/api/inventario/firma-mobiliario/enviar/${id}`,
      {},
    );
  }
  ...
  reenviarCorreoFirma(id: number): Observable<{ msg: string }> {
    return this.http.post<{ msg: string }>(
      `${this.apiUrl}/api/inventario/firma-mobiliario/reenviar/${id}`,
      {},
    );
  }

  obtenerEstadoFirma(id: number): Observable<any> {
    return this.http.get(`${this.apiUrl}/api/inventario/firma-mobiliario/estado/${id}`);
  }

  // Publico (sin token)
  obtenerActaPorToken(token: string): Observable<any> {
    return this.http.get(`${this.apiUrl}/api/inventario/firma-mobiliario/publica/${token}`);
  }

  firmarActa(
    token: string,
    firma: string,
  ): Observable<{ msg: string; fechaFirma: Date }> {
    return this.http.post<{ msg: string; fechaFirma: Date }>(
      `${this.apiUrl}/api/inventario/firma-mobiliario/publica/${token}/firmar`,
      { firma },
    );
  }
  ...
  rechazarActa(token: string, motivo: string): Observable<{ msg: string }> {
    return this.http.post<{ msg: string }>(
      `${this.apiUrl}/api/inventario/firma-mobiliario/publica/${token}/rechazar`,
      { motivo },
    );
  }
  ...
  obtenerHistorialMobiliario(mobiliarioId: number): Observable<any[]> {
    return this.http.get<any[]>(
      `${this.apiUrl}/api/inventario/actas-mobiliario/historial/${mobiliarioId}`,
    );
  }
}

...
export const routes: Routes = [
  ...
  { path: 'horas/:fecha', loadComponent: () => import('./components/horas/horas.component').then(m => m.HorasComponent), canActivate: [tRolGuard], data: { allowedRoles: ['Admin', 'Tecnologia'], modulo: 'horas' } },
